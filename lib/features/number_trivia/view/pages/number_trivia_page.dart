...
class _NumberTriviaViewState extends ConsumerState<NumberTriviaView> {
  ...
  Widget build(BuildContext context) {
    final AsyncValue<NumberTriviaModel?> numberTrivia = ref.watch(numberTriviaViewModelProvider);
        ...
        child: Column(
          ...
          children: [
            Builder(builder: (context) {
              if (numberTrivia == null || numberTrivia.number == -1) {
                return const Text(
            ...
            Text(
              (numberTrivia == null) ? '' : numberTrivia.text,
            ...
            ElevatedButton(
              onPressed: () {
                ...
                ref
                    .read(numberTriviaViewModelProvider.notifier)
            ...
            ElevatedButton(
              onPressed: () {
                ref.read(numberTriviaViewModelProvider.notifier).getRandomNumberTrivia();
              },
